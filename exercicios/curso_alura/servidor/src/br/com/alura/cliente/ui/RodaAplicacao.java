...
public class RodaAplicacao {
	...
	public static void main(String[] args){
		...
		try(Socket socket = new Socket("localhost", 12345)){
			...
			br.com.alura.cliente.ui.InterfaceGrafica ig = new br.com.alura.cliente.ui.InterfaceGrafica(socket);
			ig.montaTela();
	...
	private static void initializaThreadQueRecebeAResposta(Socket socket, br.com.alura.cliente.ui.InterfaceGrafica ig)
